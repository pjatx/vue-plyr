...
var sharedStore$1 = store$2;var functionToString$1 = Function.toString; // this helper broken in `3.4.1-3.4.4`, so we can't use `shared` helper
...
};var engineIsNode = classofRaw$1(global_1$1.process) == 'process';var engineUserAgent$1 = getBuiltIn$1('navigator', 'userAgent') || '';var process$1 = global_1$1.process;
...
var engineV8Version$1 = version$1 && +version$1;var nativeSymbol$1 = !!Object.getOwnPropertySymbols && !fails$1(function () {
  // eslint-disable-next-line es/no-symbol -- required for testing
  return !Symbol.sham && ( // Chrome 38 Symbol has incorrect toString conversion
  // Chrome 38-40 symbols are not inherited from DOM collections prototypes to instances
  engineIsNode ? engineV8Version$1 === 38 : engineV8Version$1 > 37 && engineV8Version$1 < 41);
...
if (FORCED$5) {
  var RegExpWrapper = function RegExp(pattern, flags) {
    ...
    if (UNSUPPORTED_Y$1 && sticky) setInternalState$2(result, {
      sticky: sticky
    });
    return result;
  };
...
setSpecies('RegExp');var nativeExec = RegExp.prototype.exec;
...
var setInternalState$a = internalState$2.set;
